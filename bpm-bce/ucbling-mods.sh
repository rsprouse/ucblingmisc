...
# Install .deb packages with apt-get.
# First argument is a newline-delimited list of packages (# comment lines allowed).
# Second argument is message to echo to console.
apt_get_packages(){
    echo "${2}"
